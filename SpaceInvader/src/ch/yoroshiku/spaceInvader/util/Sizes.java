...
public class Sizes {
	...
	public static final float TELEPORTER_WIDTH = 6;
	public static final float TELEPORTER_HEIGHT = 3;
	
	public static final float PEON_WIDTH = 4;
	public static final float PEON_HEIGHT = 1.8f;
	
	public static final float MIDBOSS_WIDTH = 8;
	public static final float MIDBOSS_HEIGHT = 3.6f;
	public static final float MIDSBOSS_SPLASS_WIDTH = 8;
	public static final float MIDSBOSS_SPLASS_HEIGHT = 3.6f;
	
	public static final float POWER_UP_EATER_WIDTH = 4;
	public static final float POWER_UP_EATER_HEIGHT = 6;
	
	public static final float PROMETHEUS_WIDTH = 10;
	public static final float PROMETHEUS_HEIGHT = 12;
